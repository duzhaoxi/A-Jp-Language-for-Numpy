...
import cn.simbaba.mydsl.ide.contentassist.antlr.JpParser;
import cn.simbaba.mydsl.ide.contentassist.antlr.PartialJpContentAssistParser;
import cn.simbaba.mydsl.ide.contentassist.antlr.internal.InternalJpLexer;
import cn.simbaba.mydsl.ui.contentassist.JpProposalProvider;
import cn.simbaba.mydsl.ui.editor.JpEditor;
import cn.simbaba.mydsl.ui.labeling.JpDescriptionLabelProvider;
import cn.simbaba.mydsl.ui.labeling.JpLabelProvider;
import cn.simbaba.mydsl.ui.outline.JpOutlineTreeProvider;
import cn.simbaba.mydsl.ui.quickfix.JpQuickfixProvider;
import cn.simbaba.mydsl.validation.JpValidatorConfigurationBlock;
...
/**
 * Manual modifications go to {@link JpUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractJpUiModule extends DefaultXbaseUiModule {

	public AbstractJpUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(cn.simbaba.mydsl.parser.antlr.internal.InternalJpLexer.class);
	}
	...
	public Class<? extends IContentAssistParser> bindIContentAssistParser() {
		return JpParser.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalJpLexer.class).toProvider(LexerProvider.create(InternalJpLexer.class));
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.validation.ValidatorFragment2
	public Class<? extends AbstractValidatorConfigurationBlock> bindAbstractValidatorConfigurationBlock() {
		return JpValidatorConfigurationBlock.class;
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return JpLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(JpDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return JpOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return JpQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return JpProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialJpContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("Jp Compare");
	}
