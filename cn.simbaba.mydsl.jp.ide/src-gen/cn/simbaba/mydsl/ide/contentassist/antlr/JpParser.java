...
public class JpParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, JpGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getScriptBodyAccess().getGroup(), "rule__ScriptBody__Group__0");
			builder.put(grammarAccess.getScriptBodyAccess().getGroup_1(), "rule__ScriptBody__Group_1__0");
			...
			builder.put(grammarAccess.getScriptBodyAccess().getExpressionsAssignment_1_0(), "rule__ScriptBody__ExpressionsAssignment_1_0");
