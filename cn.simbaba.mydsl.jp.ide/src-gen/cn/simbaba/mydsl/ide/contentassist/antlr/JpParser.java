 ...
 */
package cn.simbaba.mydsl.ide.contentassist.antlr;

import cn.simbaba.mydsl.ide.contentassist.antlr.internal.InternalJpParser;
...
public class JpParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(JpGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, JpGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getJpElementAccess().getAlternatives(), "rule__JpElement__Alternatives");
			builder.put(grammarAccess.getJpFeatureAccess().getAlternatives(), "rule__JpFeature__Alternatives");
			builder.put(grammarAccess.getJpStatementOrBlockAccess().getAlternatives(), "rule__JpStatementOrBlock__Alternatives");
			builder.put(grammarAccess.getJpSingleStatementAccess().getAlternatives(), "rule__JpSingleStatement__Alternatives");
			builder.put(grammarAccess.getJpBranchingStatementAccess().getAlternatives(), "rule__JpBranchingStatement__Alternatives");
			...
			builder.put(grammarAccess.getJpRangeAccess().getAlternatives(), "rule__JpRange__Alternatives");
			builder.put(grammarAccess.getJpRangeAccess().getAlternatives_2_1(), "rule__JpRange__Alternatives_2_1");
			...
			builder.put(grammarAccess.getXForLoopExpressionAccess().getAlternatives_0_0_4(), "rule__XForLoopExpression__Alternatives_0_0_4");
			builder.put(grammarAccess.getXPostfixOperationAccess().getAlternatives_1(), "rule__XPostfixOperation__Alternatives_1");
			...
			builder.put(grammarAccess.getXMemberFeatureCallAccess().getAlternatives_1_2_0_0_1(), "rule__XMemberFeatureCall__Alternatives_1_2_0_0_1");
			...
			builder.put(grammarAccess.getJpModelAccess().getGroup(), "rule__JpModel__Group__0");
			builder.put(grammarAccess.getJpScriptAccess().getGroup(), "rule__JpScript__Group__0");
			builder.put(grammarAccess.getJpScriptAccess().getGroup_4(), "rule__JpScript__Group_4__0");
			builder.put(grammarAccess.getJpScriptBodyAccess().getGroup(), "rule__JpScriptBody__Group__0");
			builder.put(grammarAccess.getJpScriptBodyAccess().getGroup_1(), "rule__JpScriptBody__Group_1__0");
			builder.put(grammarAccess.getJpPackageDeclarationAccess().getGroup(), "rule__JpPackageDeclaration__Group__0");
			builder.put(grammarAccess.getJpClassAccess().getGroup(), "rule__JpClass__Group__0");
			builder.put(grammarAccess.getJpClassAccess().getGroup_2(), "rule__JpClass__Group_2__0");
			builder.put(grammarAccess.getJpPropertyAccess().getGroup(), "rule__JpProperty__Group__0");
			builder.put(grammarAccess.getJpOperationAccess().getGroup(), "rule__JpOperation__Group__0");
			builder.put(grammarAccess.getJpOperationAccess().getGroup_3(), "rule__JpOperation__Group_3__0");
			builder.put(grammarAccess.getJpOperationAccess().getGroup_3_1(), "rule__JpOperation__Group_3_1__0");
			builder.put(grammarAccess.getJpOperationAccess().getGroup_5(), "rule__JpOperation__Group_5__0");
			builder.put(grammarAccess.getJpBranchingStatementAccess().getGroup_0(), "rule__JpBranchingStatement__Group_0__0");
			builder.put(grammarAccess.getJpBranchingStatementAccess().getGroup_1(), "rule__JpBranchingStatement__Group_1__0");
			builder.put(grammarAccess.getJpWithOpenAsCallAccess().getGroup(), "rule__JpWithOpenAsCall__Group__0");
			builder.put(grammarAccess.getJpWithOpenAsCallAccess().getGroup_2(), "rule__JpWithOpenAsCall__Group_2__0");
			builder.put(grammarAccess.getJpWithOpenAsCallAccess().getGroup_2_1(), "rule__JpWithOpenAsCall__Group_2_1__0");
			builder.put(grammarAccess.getJpWithOpenAsCallAccess().getGroup_2_1_1(), "rule__JpWithOpenAsCall__Group_2_1_1__0");
			...
			builder.put(grammarAccess.getJpArrayConstructorCallAccess().getGroup(), "rule__JpArrayConstructorCall__Group__0");
			builder.put(grammarAccess.getJpArrayConstructorCallAccess().getGroup_0(), "rule__JpArrayConstructorCall__Group_0__0");
			builder.put(grammarAccess.getJpArrayConstructorCallAccess().getGroup_0_0(), "rule__JpArrayConstructorCall__Group_0_0__0");
			builder.put(grammarAccess.getJpArrayConstructorCallAccess().getGroup_3(), "rule__JpArrayConstructorCall__Group_3__0");
			builder.put(grammarAccess.getJpArrayLiteralAccess().getGroup(), "rule__JpArrayLiteral__Group__0");
			builder.put(grammarAccess.getJpArrayLiteralAccess().getGroup_2(), "rule__JpArrayLiteral__Group_2__0");
			builder.put(grammarAccess.getJpArrayLiteralAccess().getGroup_2_1(), "rule__JpArrayLiteral__Group_2_1__0");
			builder.put(grammarAccess.getJpArrayDimensionAccess().getGroup(), "rule__JpArrayDimension__Group__0");
			builder.put(grammarAccess.getJpFeatureCallWithArrayAccessAccess().getGroup(), "rule__JpFeatureCallWithArrayAccess__Group__0");
			builder.put(grammarAccess.getJpFeatureCallWithArrayAccessAccess().getGroup_1(), "rule__JpFeatureCallWithArrayAccess__Group_1__0");
			builder.put(grammarAccess.getJpFeatureCallWithArrayAccessAccess().getGroup_1_0(), "rule__JpFeatureCallWithArrayAccess__Group_1_0__0");
			builder.put(grammarAccess.getJpIndexAccess().getGroup(), "rule__JpIndex__Group__0");
			builder.put(grammarAccess.getJpIndexAccess().getGroup_3(), "rule__JpIndex__Group_3__0");
			builder.put(grammarAccess.getJpRangeAccess().getGroup_0(), "rule__JpRange__Group_0__0");
			builder.put(grammarAccess.getJpRangeAccess().getGroup_1(), "rule__JpRange__Group_1__0");
			builder.put(grammarAccess.getJpRangeAccess().getGroup_2(), "rule__JpRange__Group_2__0");
			builder.put(grammarAccess.getJpRangeAccess().getGroup_2_1_0(), "rule__JpRange__Group_2_1_0__0");
			builder.put(grammarAccess.getJpRangeAccess().getGroup_2_1_0_0(), "rule__JpRange__Group_2_1_0_0__0");
			builder.put(grammarAccess.getJpRangeAccess().getGroup_2_1_1(), "rule__JpRange__Group_2_1_1__0");
			builder.put(grammarAccess.getJpRangeAccess().getGroup_2_1_1_0(), "rule__JpRange__Group_2_1_1_0__0");
			builder.put(grammarAccess.getJpLetVarDeclarationAccess().getGroup(), "rule__JpLetVarDeclaration__Group__0");
			builder.put(grammarAccess.getJpLetVarDeclarationAccess().getGroup_0(), "rule__JpLetVarDeclaration__Group_0__0");
			builder.put(grammarAccess.getJpLetVarDeclarationAccess().getGroup_0_0(), "rule__JpLetVarDeclaration__Group_0_0__0");
			builder.put(grammarAccess.getJpLetVarDeclarationAccess().getGroup_1(), "rule__JpLetVarDeclaration__Group_1__0");
			builder.put(grammarAccess.getJpAdditionalVariableDeclarationAccess().getGroup(), "rule__JpAdditionalVariableDeclaration__Group__0");
			builder.put(grammarAccess.getJpWithOpenAsAccess().getGroup(), "rule__JpWithOpenAs__Group__0");
			...
			builder.put(grammarAccess.getXPostfixOperationAccess().getGroup_1_0_0(), "rule__XPostfixOperation__Group_1_0_0__0");
			builder.put(grammarAccess.getXPostfixOperationAccess().getGroup_1_1(), "rule__XPostfixOperation__Group_1_1__0");
			builder.put(grammarAccess.getXPostfixOperationAccess().getGroup_1_1_0(), "rule__XPostfixOperation__Group_1_1_0__0");
			builder.put(grammarAccess.getXPostfixOperationAccess().getGroup_1_1_0_4(), "rule__XPostfixOperation__Group_1_1_0_4__0");
			...
			builder.put(grammarAccess.getXImportDeclarationAccess().getGroup_1_2(), "rule__XImportDeclaration__Group_1_2__0");
			...
			builder.put(grammarAccess.getXAssignmentAccess().getGroup_0_0_0_4(), "rule__XAssignment__Group_0_0_0_4__0");
			builder.put(grammarAccess.getXAssignmentAccess().getGroup_0_0_0_6(), "rule__XAssignment__Group_0_0_0_6__0");
			...
			builder.put(grammarAccess.getXMemberFeatureCallAccess().getGroup_1_0_0_0_5(), "rule__XMemberFeatureCall__Group_1_0_0_0_5__0");
			builder.put(grammarAccess.getXMemberFeatureCallAccess().getGroup_1_0_0_0_7(), "rule__XMemberFeatureCall__Group_1_0_0_0_7__0");
			...
			builder.put(grammarAccess.getXMemberFeatureCallAccess().getGroup_1_2_1(), "rule__XMemberFeatureCall__Group_1_2_1__0");
			builder.put(grammarAccess.getXMemberFeatureCallAccess().getGroup_1_2_1_2(), "rule__XMemberFeatureCall__Group_1_2_1_2__0");
			builder.put(grammarAccess.getXMemberFeatureCallAccess().getGroup_1_2_3(), "rule__XMemberFeatureCall__Group_1_2_3__0");
			builder.put(grammarAccess.getXMemberFeatureCallAccess().getGroup_1_2_3_1(), "rule__XMemberFeatureCall__Group_1_2_3_1__0");
			builder.put(grammarAccess.getXMemberFeatureCallAccess().getGroup_1_2_3_1_1(), "rule__XMemberFeatureCall__Group_1_2_3_1_1__0");
			...
			builder.put(grammarAccess.getJpModelAccess().getImportSectionAssignment_0(), "rule__JpModel__ImportSectionAssignment_0");
			builder.put(grammarAccess.getJpModelAccess().getElementsAssignment_1(), "rule__JpModel__ElementsAssignment_1");
			builder.put(grammarAccess.getJpModelAccess().getScriptsAssignment_2(), "rule__JpModel__ScriptsAssignment_2");
			builder.put(grammarAccess.getJpScriptAccess().getNameAssignment_1(), "rule__JpScript__NameAssignment_1");
			builder.put(grammarAccess.getJpScriptAccess().getAuthorAssignment_3(), "rule__JpScript__AuthorAssignment_3");
			builder.put(grammarAccess.getJpScriptAccess().getSuperTypeAssignment_4_1(), "rule__JpScript__SuperTypeAssignment_4_1");
			builder.put(grammarAccess.getJpScriptAccess().getOperationsAssignment_5(), "rule__JpScript__OperationsAssignment_5");
			builder.put(grammarAccess.getJpScriptAccess().getScriptBodyAssignment_6(), "rule__JpScript__ScriptBodyAssignment_6");
			builder.put(grammarAccess.getJpScriptBodyAccess().getExpressionsAssignment_1_0(), "rule__JpScriptBody__ExpressionsAssignment_1_0");
			builder.put(grammarAccess.getJpPackageDeclarationAccess().getNameAssignment_1(), "rule__JpPackageDeclaration__NameAssignment_1");
			builder.put(grammarAccess.getJpPackageDeclarationAccess().getElementsAssignment_3(), "rule__JpPackageDeclaration__ElementsAssignment_3");
			builder.put(grammarAccess.getJpClassAccess().getNameAssignment_1(), "rule__JpClass__NameAssignment_1");
			builder.put(grammarAccess.getJpClassAccess().getSuperTypeAssignment_2_1(), "rule__JpClass__SuperTypeAssignment_2_1");
			builder.put(grammarAccess.getJpClassAccess().getFeaturesAssignment_4(), "rule__JpClass__FeaturesAssignment_4");
			builder.put(grammarAccess.getJpPropertyAccess().getNameAssignment_0(), "rule__JpProperty__NameAssignment_0");
			builder.put(grammarAccess.getJpPropertyAccess().getTypeAssignment_2(), "rule__JpProperty__TypeAssignment_2");
			builder.put(grammarAccess.getJpOperationAccess().getNameAssignment_1(), "rule__JpOperation__NameAssignment_1");
			builder.put(grammarAccess.getJpOperationAccess().getParamsAssignment_3_0(), "rule__JpOperation__ParamsAssignment_3_0");
			builder.put(grammarAccess.getJpOperationAccess().getParamsAssignment_3_1_1(), "rule__JpOperation__ParamsAssignment_3_1_1");
			builder.put(grammarAccess.getJpOperationAccess().getTypeAssignment_5_1(), "rule__JpOperation__TypeAssignment_5_1");
			builder.put(grammarAccess.getJpOperationAccess().getBodyAssignment_6(), "rule__JpOperation__BodyAssignment_6");
			builder.put(grammarAccess.getJpWithOpenAsCallAccess().getFeatureAssignment_1(), "rule__JpWithOpenAsCall__FeatureAssignment_1");
			builder.put(grammarAccess.getJpWithOpenAsCallAccess().getExplicitOperationCallAssignment_2_0(), "rule__JpWithOpenAsCall__ExplicitOperationCallAssignment_2_0");
			builder.put(grammarAccess.getJpWithOpenAsCallAccess().getFeatureCallArgumentsAssignment_2_1_0(), "rule__JpWithOpenAsCall__FeatureCallArgumentsAssignment_2_1_0");
			builder.put(grammarAccess.getJpWithOpenAsCallAccess().getFeatureCallArgumentsAssignment_2_1_1_1(), "rule__JpWithOpenAsCall__FeatureCallArgumentsAssignment_2_1_1_1");
			...
			builder.put(grammarAccess.getJpArrayConstructorCallAccess().getTypeAssignment_0_0_2(), "rule__JpArrayConstructorCall__TypeAssignment_0_0_2");
			builder.put(grammarAccess.getJpArrayConstructorCallAccess().getDimensionsAssignment_0_0_3(), "rule__JpArrayConstructorCall__DimensionsAssignment_0_0_3");
			builder.put(grammarAccess.getJpArrayConstructorCallAccess().getIndexesAssignment_1(), "rule__JpArrayConstructorCall__IndexesAssignment_1");
			builder.put(grammarAccess.getJpArrayConstructorCallAccess().getDimensionsAssignment_3_0(), "rule__JpArrayConstructorCall__DimensionsAssignment_3_0");
			builder.put(grammarAccess.getJpArrayConstructorCallAccess().getIndexesAssignment_3_1(), "rule__JpArrayConstructorCall__IndexesAssignment_3_1");
			builder.put(grammarAccess.getJpArrayConstructorCallAccess().getArrayLiteralAssignment_4(), "rule__JpArrayConstructorCall__ArrayLiteralAssignment_4");
			builder.put(grammarAccess.getJpArrayLiteralAccess().getElementsAssignment_2_0(), "rule__JpArrayLiteral__ElementsAssignment_2_0");
			builder.put(grammarAccess.getJpArrayLiteralAccess().getElementsAssignment_2_1_1(), "rule__JpArrayLiteral__ElementsAssignment_2_1_1");
			builder.put(grammarAccess.getJpFeatureCallWithArrayAccessAccess().getIndexesAssignment_1_0_1(), "rule__JpFeatureCallWithArrayAccess__IndexesAssignment_1_0_1");
			builder.put(grammarAccess.getJpFeatureCallWithArrayAccessAccess().getIndexesAssignment_1_0_2(), "rule__JpFeatureCallWithArrayAccess__IndexesAssignment_1_0_2");
			builder.put(grammarAccess.getJpIndexAccess().getIndexesAssignment_2(), "rule__JpIndex__IndexesAssignment_2");
			builder.put(grammarAccess.getJpIndexAccess().getIndexesAssignment_3_1(), "rule__JpIndex__IndexesAssignment_3_1");
			builder.put(grammarAccess.getJpRangeAccess().getFeatureAssignment_0_1(), "rule__JpRange__FeatureAssignment_0_1");
			builder.put(grammarAccess.getJpRangeAccess().getOperandAssignment_0_2(), "rule__JpRange__OperandAssignment_0_2");
			builder.put(grammarAccess.getJpRangeAccess().getFeatureAssignment_1_1(), "rule__JpRange__FeatureAssignment_1_1");
			builder.put(grammarAccess.getJpRangeAccess().getFeatureAssignment_2_1_0_0_1(), "rule__JpRange__FeatureAssignment_2_1_0_0_1");
			builder.put(grammarAccess.getJpRangeAccess().getFeatureAssignment_2_1_1_0_1(), "rule__JpRange__FeatureAssignment_2_1_1_0_1");
			builder.put(grammarAccess.getJpRangeAccess().getRightOperandAssignment_2_1_1_0_2(), "rule__JpRange__RightOperandAssignment_2_1_1_0_2");
			builder.put(grammarAccess.getJpLetVarDeclarationAccess().getNameAssignment_0_0_2(), "rule__JpLetVarDeclaration__NameAssignment_0_0_2");
			builder.put(grammarAccess.getJpLetVarDeclarationAccess().getOtherAssignment_1_1(), "rule__JpLetVarDeclaration__OtherAssignment_1_1");
			builder.put(grammarAccess.getJpLetVarDeclarationAccess().getRightAssignment_3(), "rule__JpLetVarDeclaration__RightAssignment_3");
			builder.put(grammarAccess.getJpAdditionalVariableDeclarationAccess().getNameAssignment_1(), "rule__JpAdditionalVariableDeclaration__NameAssignment_1");
			builder.put(grammarAccess.getJpWithOpenAsAccess().getOpenAssignment_2(), "rule__JpWithOpenAs__OpenAssignment_2");
			builder.put(grammarAccess.getJpWithOpenAsAccess().getNameAssignment_4(), "rule__JpWithOpenAs__NameAssignment_4");
			builder.put(grammarAccess.getJpWithOpenAsAccess().getWithExpressionAssignment_5(), "rule__JpWithOpenAs__WithExpressionAssignment_5");
			...
			builder.put(grammarAccess.getXPostfixOperationAccess().getFeatureAssignment_1_0_0_1(), "rule__XPostfixOperation__FeatureAssignment_1_0_0_1");
			builder.put(grammarAccess.getXPostfixOperationAccess().getIndexesAssignment_1_1_0_2(), "rule__XPostfixOperation__IndexesAssignment_1_1_0_2");
			builder.put(grammarAccess.getXPostfixOperationAccess().getIndexesAssignment_1_1_0_4_1(), "rule__XPostfixOperation__IndexesAssignment_1_1_0_4_1");
			...
			builder.put(grammarAccess.getXImportDeclarationAccess().getImportedNamespaceAssignment_1_2_1(), "rule__XImportDeclaration__ImportedNamespaceAssignment_1_2_1");
			builder.put(grammarAccess.getXImportDeclarationAccess().getAliasAssignment_1_2_3(), "rule__XImportDeclaration__AliasAssignment_1_2_3");
			...
			builder.put(grammarAccess.getXAssignmentAccess().getIndexesAssignment_0_0_0_4_1(), "rule__XAssignment__IndexesAssignment_0_0_0_4_1");
			builder.put(grammarAccess.getXAssignmentAccess().getIndexesAssignment_0_0_0_6_1(), "rule__XAssignment__IndexesAssignment_0_0_0_6_1");
			...
			builder.put(grammarAccess.getXMemberFeatureCallAccess().getIndexesAssignment_1_0_0_0_4(), "rule__XMemberFeatureCall__IndexesAssignment_1_0_0_0_4");
			builder.put(grammarAccess.getXMemberFeatureCallAccess().getIndexesAssignment_1_0_0_0_5_1(), "rule__XMemberFeatureCall__IndexesAssignment_1_0_0_0_5_1");
			builder.put(grammarAccess.getXMemberFeatureCallAccess().getIndexesAssignment_1_0_0_0_7_1(), "rule__XMemberFeatureCall__IndexesAssignment_1_0_0_0_7_1");
			...
			builder.put(grammarAccess.getXMemberFeatureCallAccess().getExplicitStaticAssignment_1_1_0_0_1_1(), "rule__XMemberFeatureCall__ExplicitStaticAssignment_1_1_0_0_1_1");
			...
			builder.put(grammarAccess.getXMemberFeatureCallAccess().getNullSafeAssignment_1_2_0_0_1_1(), "rule__XMemberFeatureCall__NullSafeAssignment_1_2_0_0_1_1");
			builder.put(grammarAccess.getXMemberFeatureCallAccess().getExplicitStaticAssignment_1_2_0_0_1_2(), "rule__XMemberFeatureCall__ExplicitStaticAssignment_1_2_0_0_1_2");
			builder.put(grammarAccess.getXMemberFeatureCallAccess().getTypeArgumentsAssignment_1_2_1_1(), "rule__XMemberFeatureCall__TypeArgumentsAssignment_1_2_1_1");
			builder.put(grammarAccess.getXMemberFeatureCallAccess().getTypeArgumentsAssignment_1_2_1_2_1(), "rule__XMemberFeatureCall__TypeArgumentsAssignment_1_2_1_2_1");
			builder.put(grammarAccess.getXMemberFeatureCallAccess().getFeatureAssignment_1_2_2(), "rule__XMemberFeatureCall__FeatureAssignment_1_2_2");
			builder.put(grammarAccess.getXMemberFeatureCallAccess().getExplicitOperationCallAssignment_1_2_3_0(), "rule__XMemberFeatureCall__ExplicitOperationCallAssignment_1_2_3_0");
			builder.put(grammarAccess.getXMemberFeatureCallAccess().getMemberCallArgumentsAssignment_1_2_3_1_0(), "rule__XMemberFeatureCall__MemberCallArgumentsAssignment_1_2_3_1_0");
			builder.put(grammarAccess.getXMemberFeatureCallAccess().getMemberCallArgumentsAssignment_1_2_3_1_1_1(), "rule__XMemberFeatureCall__MemberCallArgumentsAssignment_1_2_3_1_1_1");
	...
	@Override
	protected InternalJpParser createParser() {
		InternalJpParser result = new InternalJpParser(null);
